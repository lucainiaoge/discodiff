...
os.chdir("..")
try:
    from data.h5_dataset_huggingface import DacEncodecClapTextFeatDatasetJamendocaps
    from data.create_h5_dataset import create_h5_dataset_given_audio_dir, get_dac_encodec_clap
except:
    from h5_dataset_huggingface import DacEncodecClapTextFeatDatasetJamendocaps
...
def create_h5_dataset_jamendo_maxcaps(
    json_path, target_dir, dac_model, encodec_model, clap_model,
